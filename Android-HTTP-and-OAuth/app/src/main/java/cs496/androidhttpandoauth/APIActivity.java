...
public class APIActivity extends AppCompatActivity {
    ...
    void updateAuthState(){
        ...
        Uri redirect = new Uri.Builder().scheme("cs496.androidhttpandoauth").path("foo").build();

        AuthorizationServiceConfiguration config = new AuthorizationServiceConfiguration(authEndpoint, tokenEndpoint, null);
        AuthorizationRequest req = new AuthorizationRequest.Builder(config, "1037790457481-k5mftqtc49evrc9eqjoacq3a418e0ghr.apps.googleusercontent.com", ResponseTypeValues.CODE, redirect)
